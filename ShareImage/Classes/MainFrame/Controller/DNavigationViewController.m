...
@implementation DNavigationViewController
...
- (void)viewDidLoad {
    ...
    // 改变Push&Pop方式，包括连导航栏一起
    [self setupPushPopAnimation];
